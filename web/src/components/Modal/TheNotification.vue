...
<script lang="ts">
import { NotificationEnum, NotificationType } from "@/stores/notification";
...
export default {
  ...
  methods: {
    getNotificationColorClass(type: NotificationEnum) {
      switch (type) {
    ...
    closeNotificiation(notificationId: number) {
