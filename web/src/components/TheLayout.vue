<template>
  <TheSideBar v-if="$route.path != '/' && $route.path != '/register'" />

  <main class="main">
    <!-- Routines -->
    <EditRoutineModal
      v-if="modalStore.open && getActiveModal() == 'editRoutine'"
    />
    <CreateRoutineModal
      v-if="modalStore.open && getActiveModal() == 'createRoutine'"
    />
    <SetRoutineModalConfirm
      v-if="modalStore.open && getActiveModal() == 'confirmSelectedRoutine'"
    />
    <ForceFinishRoutine
      v-if="modalStore.open && getActiveModal() == 'forceFinishRoutine'"
    />

    <!-- Tasks  -->
    <CreateTaskModal
      v-if="modalStore.open && getActiveModal() == 'createTask'"
    />
    ...
    <!-- Dashboard -->
    <SelectDateModal
      v-if="modalStore.open && getActiveModal() == 'selectDate'"
    />
