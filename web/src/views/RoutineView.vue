<template>
  <TheLayout>
    <div class="content">
      ...
      <button class="create-routine" @click="createRoutine()">
        <FontAwesomeIcon icon="plus" class="plus-icon" />
        <p>Criar Nova Rotina</p>
        <p>
          <small> Monte uma rotina personalizada para seus objetivos </small>
        </p>
      </button>
    ...
    async setRoutines() {
      try {
        ...
        this.showNotification({
          title: "Ocorreu um erro ao carregar as rotinas",
          time: 3000,
...
.create-routine:hover {
  border: solid 2px oklch(0.809 0.105 251.813);
